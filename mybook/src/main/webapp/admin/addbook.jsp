            ...
            <div class="text-center animated fadeInRightBig">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" action="/book/addbook" method="post" enctype="multipart/form-data">

                            <!--书名-->
                            <div class="form-group">
                                <label for="bookname" class="col-sm-2 control-label">书名:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="bookname" name="bookname" placeholder="请输入书籍名字">
                                </div>
                            </div>
                            <!--作者-->
                            <div class="form-group">
...
<script>
    ...
    let i = 0;
    function addpic() {
        let ss = "请选择: <input type='file' id='img' name='img'/>"
        $("#pics").append(ss);
    }
</script>
</body>
